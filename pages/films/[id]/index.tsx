    ...
    <div className="min-h-screen pt-2">
      {film != undefined ? (
        <div className=" flex pr-2 pl-2">
          <aside
            className="w-1/3 border-solid border-4 rounded-xl"
            style={{
          ...
          <aside className="w-full grid pl-2">
            ...
            >
              <aside
                className="border-4 rounded-xl w-4/6"
                style={{
                  borderColor: 'rgb(7, 157, 236)',
                }}
              >
              ...
              <aside
                className="border-4 rounded-xl w-2/6"
                style={{
                  borderColor: 'rgb(7, 157, 236)',
                }}
              >
                <h1 className="text-white font-bold text-xl text-center py-1 underline">
                  Synopsis :
                </h1>
      ...
      <div className="justify-center flex py-10">
        <button
          className="btn btn-primary text-5xl h-20 font-normal normal-case"
          style={{
            borderColor: 'rgb(7, 157, 236)',
